...
- create app che che permette di fare login controllando credenziali tramite file di testo `credentials.txt` creato al lancio dell’app
- l’app risulta vulnerabile in quanto non fa controllo della versione corrente in quanto l’app potrebbe essere una versione obsoleta con delle vulnerabilità.
- l’app dovrebbe fare un controllo simile a questo (fonte owasp)
